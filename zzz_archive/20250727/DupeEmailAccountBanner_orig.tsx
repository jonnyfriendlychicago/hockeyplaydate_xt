  ...
  return (
      <div className="w-full max-w-3xl mx-auto px-4 py-6 my-6 rounded-lg border border-r-4 border-b-4 border-red-500 bg-red-50">
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          <p>
            You cannot use Hockey Playdate with your current login. Here is a quick explanation, plus resolution options. 
          </p>
          <div>
            ...
            <br/>
            <p>
                The account you&#39;re logged in with right now (account type: {accountType}) has the same email address - <strong>{email}</strong> - as an existing {altAccountType} account. 
                </p>
            <p>
              For security and sanity reasons, Hockey Playdate blocks your  {accountType} login.
            </p>
          </div>
