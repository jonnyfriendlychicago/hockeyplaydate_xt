...
export function MemberRsvpCard({ 
  ...
  // return (
  //   <div 
  //     // className={`flex items-start justify-between p-4 border-2 rounded-lg hover:bg-muted/50 transition-colors ${statusClass}`}
  //     className={`flex items-center justify-between p-4 border-2 rounded-lg hover:bg-muted/50 transition-colors ${statusClass}`}
  //   >
  ...
  //     {/* Edit Button - only for managers, not on own card */}
  //     {showEditButton && (
  //       <Button
  //         variant="ghost"
  //         size="sm"
