...
return ( 
    <main>
      ...
      <p>
        This is a placeholder page for what eventually will be the production chapters (aka chapter list) page. <br/>
        All users will see an about-groups info blurb.   <br/>
