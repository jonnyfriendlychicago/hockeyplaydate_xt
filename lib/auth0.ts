...
// 2025oct25: ALL of below temporarily replaced by above, see if that solves our redirect issue. 
...
//     // NEW: Check for returnTo parameter
...
//     // Validate returnTo is a local path (security check)
//     const isValidReturnTo = returnTo.startsWith('/') && !returnTo.startsWith('//');
//     const destination = isValidReturnTo ? returnTo : '/';
